...
public class CGPACalculator extends JFrame {
    ...
    public CGPACalculator() {
        ...
        unitsL = new JLabel("Enter number of units/Point: ", SwingConstants.RIGHT);
        ...
        // Create Add Button
        addButton = new JButton("Add Another Subject Point");
        abHandler = new AddButtonHandler();
        addButton.addActionListener(abHandler);

        // Create GPA Button
        gpaButton = new JButton("Click to find out CGPA");
    ...
    private class GPAButtonHandler implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (gradePoints == 0.0) {
                ...
                String outputStr = "CGPA: " + df.format(totalGPA) + "\n";
    ...
    public static void main(String[] args) {
        CGPACalculator gpaCalculator = new CGPACalculator();
    }
}
